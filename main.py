...
def main():
	...
	print("Exclusive Test: " + str(100 * round((len(scenario_1_results) / len(trial_results_scen1)), 2)))
	...
	print("Inclusive Test: " + str(100 * round((len(scenario_2_results) / len(trial_results_scen2)), 2)))
